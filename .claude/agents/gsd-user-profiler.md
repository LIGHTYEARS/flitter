...
<reference>
@/Users/bytedance/.oh-my-coco/studio/flitter/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/Users/bytedance/.oh-my-coco/studio/flitter/.claude/get-shit-done/references/user-profiling.md` to load:
