...
Intel system is disabled. To activate:
  ...
  node /Users/bytedance/.oh-my-coco/studio/flitter/.claude/get-shit-done/bin/gsd-tools.cjs config-set intel.enabled true
...
```bash
node /Users/bytedance/.oh-my-coco/studio/flitter/.claude/get-shit-done/bin/gsd-tools.cjs intel query <term>
```
...
```bash
node /Users/bytedance/.oh-my-coco/studio/flitter/.claude/get-shit-done/bin/gsd-tools.cjs intel status
```
...
```bash
node /Users/bytedance/.oh-my-coco/studio/flitter/.claude/get-shit-done/bin/gsd-tools.cjs intel diff
```
...
Project root: ${CWD}
gsd-tools path: /Users/bytedance/.oh-my-coco/studio/flitter/.claude/get-shit-done/bin/gsd-tools.cjs
