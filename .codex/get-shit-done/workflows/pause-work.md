...
<step name="commit">
```bash
node "/Users/bytedance/.oh-my-coco/studio/flitter/.codex/get-shit-done/bin/gsd-tools.cjs" commit "wip: [phase-name] paused at task [X]/[Y]" --files .planning/phases/*/.continue-here.md .planning/HANDOFF.json
```
</step>
