...
<required_reading>
@/Users/bytedance/.oh-my-coco/studio/flitter/.trae/get-shit-done/references/continuation-format.md
</required_reading>
...
```bash
INIT=$(node "/Users/bytedance/.oh-my-coco/studio/flitter/.trae/get-shit-done/bin/gsd-tools.cjs" init resume)
