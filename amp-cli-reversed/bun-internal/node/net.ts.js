...
var getDefaultAutoSelectFamily = @lazy(63), setDefaultAutoSelectFamily = @lazy(64), getDefaultAutoSelectFamilyAttemptTimeout = @lazy(65), setDefaultAutoSelectFamilyAttemptTimeout = @lazy(66), SocketAddress = @lazy(67), BlockList = @lazy(68), newDetachedSocket = @lazy(69), doConnect = @lazy(70), addServerName = @lazy(71), upgradeDuplexToTLS = @lazy(38), isNamedPipeSocket = @lazy(72), getBufferedAmount = @lazy(73), bunTlsSymbol = Symbol.for("::buntls::"), bunSocketServerOptions = Symbol.for("::bunnetserveroptions::"), owner_symbol = Symbol("owner_symbol"), kServerSocket = Symbol("kServerSocket"), kBytesWritten = Symbol("kBytesWritten"), bunTLSConnectOptions = Symbol.for("::buntlsconnectoptions::"), kReinitializeHandle = Symbol("kReinitializeHandle"), kRealListen = Symbol("kRealListen"), kSetNoDelay = Symbol("kSetNoDelay"), kSetKeepAlive = Symbol("kSetKeepAlive"), kSetKeepAliveInitialDelay = Symbol("kSetKeepAliveInitialDelay"), kConnectOptions = Symbol("connect-options"), kAttach = Symbol("kAttach"), kCloseRawConnection = Symbol("kCloseRawConnection"), kpendingRead = Symbol("kpendingRead"), kupgraded = Symbol("kupgraded"), ksocket = Symbol("ksocket"), khandlers = Symbol("khandlers"), kclosed = Symbol("closed"), kended = Symbol("ended"), kwriteCallback = Symbol("writeCallback"), kSocketClass = Symbol("kSocketClass");
...
Socket.prototype._write = function _write(chunk, encoding, callback) {
  if (this.connecting) {
    ...
    this[kwriteCallback] = callback, this._pendingData = chunk, this._pendingEncoding = encoding, this.once("connect", function connect() {
