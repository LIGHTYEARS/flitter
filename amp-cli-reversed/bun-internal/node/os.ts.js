(function (){"use strict";// build/release/tmp_modules/node/os.ts
var $, tmpdir = function() {
  var env = Bun.env;
  return tmpdir = function() {
    ...
    if (length > 1 && path[length - 1] === "/")
      path = path.slice(0, -1);
    return path;
  }, tmpdir[Symbol.toPrimitive] = tmpdir, tmpdir();
};
function lazyCpus({ cpus }) {
  return () => {
    let array = new @Array(navigator.hardwareConcurrency);
    function populate() {
