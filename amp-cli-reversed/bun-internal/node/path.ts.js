...
var $, { validateString } = @getInternalField(@internalModuleRegistry, 68) || @createInternalModuleById(68), [bindingPosix, bindingWin32] = @lazy(75), toNamespacedPathPosix = bindingPosix.toNamespacedPath.bind(bindingPosix), toNamespacedPathWin32 = bindingWin32.toNamespacedPath.bind(bindingWin32), posix = {
