...
} = @lazy(84), { validateInteger } = @getInternalField(@internalModuleRegistry, 68) || @createInternalModuleById(68), fs = @getInternalField(@internalModuleRegistry, 23) || @createInternalModuleById(23);
