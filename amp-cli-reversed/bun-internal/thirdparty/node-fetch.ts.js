...
var $, bindings = @lazy(97), WebResponse = bindings[0], WebRequest = bindings[1], Blob = bindings[2], WebHeaders = bindings[3], FormData = bindings[4], File = bindings[5], nativeFetch = Bun.fetch;
