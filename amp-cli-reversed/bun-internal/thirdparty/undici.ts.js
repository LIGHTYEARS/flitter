(function (){"use strict";// build/release/tmp_modules/thirdparty/undici.ts
var $, EventEmitter = @getInternalField(@internalModuleRegistry, 96) || @createInternalModuleById(96), StreamModule = @getInternalField(@internalModuleRegistry, 117) || @createInternalModuleById(117), { Readable } = StreamModule, { _ReadableFromWeb: ReadableFromWeb } = @getInternalField(@internalModuleRegistry, 69) || @createInternalModuleById(69), ObjectCreate = Object.create, kEmptyObject = ObjectCreate(null), fetch = Bun.fetch, bindings = @lazy(98), Response = bindings[0], Request = bindings[1], Headers = bindings[2], FormData = bindings[3], File = bindings[4], URL = bindings[5], AbortSignal = bindings[6], URLSearchParams = bindings[7], WebSocket = bindings[8], CloseEvent = bindings[9], ErrorEvent = bindings[10], MessageEvent = bindings[11];
