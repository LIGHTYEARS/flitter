...
var require_safe_buffer = __commonJS((exports, module) => {
  /*! safe-buffer. MIT License. Feross Aboukhadijeh <https://feross.org/opensource> */ var buffer = require("buffer"),
  ...
  else (copyProps(buffer, exports), (exports.Buffer = SafeBuffer));
...
var require_has_symbols = __commonJS((exports, module) => {
  ...
  module.exports = function () {
    if (typeof origSymbol !== "function") return !1;
  ...
  var ERROR_MESSAGE = "Function.prototype.bind called on incompatible ",
    ...
    joiny = function (arr, joiner) {
      ...
      for (var i = 0; i < arr.length; i += 1)
        if (((str += arr[i]), i + 1 < arr.length)) str += joiner;
      return str;
    };
...
var require_available_typed_arrays = __commonJS((exports, module) => {
  var possibleNames = require_possible_typed_array_names(),
    g = typeof globalThis > "u" ? globalThis : globalThis;
  module.exports = function () {
    var out = [];
...
var require_set_function_length = __commonJS((exports, module) => {
  ...
  module.exports = function (fn, length) {
    ...
    if ("length" in fn && gOPD) {
      ...
      if (desc && !desc.configurable) functionLengthIsConfigurable = !1;
      if (desc && !desc.writable) functionLengthIsWritable = !1;
    }
    if (functionLengthIsConfigurable || functionLengthIsWritable || !loose)
      if (hasDescriptors) define(fn, "length", length, !0, !0);
...
var require_call_bind = __commonJS((exports, module) => {
  var setFunctionLength = require_set_function_length(),
    $defineProperty = require_es_define_property(),
    callBindBasic = require_call_bind_apply_helpers(),
    applyBind = require_applyBind();
  module.exports = function (originalFunction) {
    var func = callBindBasic(arguments),
      adjustedLength = originalFunction.length - (arguments.length - 1);
...
var require_which_typed_array = __commonJS((exports, module) => {
  var forEach = require_for_each(),
    availableTypedArrays = require_available_typed_arrays(),
    callBind = require_call_bind(),
    callBound = require_call_bound(),
    gOPD = require_gopd(),
    getProto = require_get_proto(),
...
var require_typed_array_buffer = __commonJS((exports, module) => {
  var $TypeError = require_type(),
    callBound = require_call_bound(),
    $typedArrayBuffer = callBound("TypedArray.prototype.buffer", !0),
    isTypedArray = require_is_typed_array();
  module.exports =
    $typedArrayBuffer ||
    function (x) {
...
var require_to_buffer = __commonJS((exports, module) => {
  var Buffer2 = require_safe_buffer().Buffer,
    ...
    typedArrayBuffer = require_typed_array_buffer(),
    isView =
      ArrayBuffer.isView ||
      function (obj) {
        try {
          return (typedArrayBuffer(obj), !0);
        } catch (e) {
          return !1;
        }
      },
    useUint8Array = typeof Uint8Array < "u",
    useArrayBuffer = typeof ArrayBuffer < "u" && typeof Uint8Array < "u",
    useFromArrayBuffer =
      useArrayBuffer &&
      (Buffer2.prototype instanceof Uint8Array || Buffer2.TYPED_ARRAY_SUPPORT);
  module.exports = function (data, encoding) {
    if (Buffer2.isBuffer(data)) {
      if (data.constructor && !("isBuffer" in data)) return Buffer2.from(data);
      return data;
    }
...
var require_async = __commonJS((exports, module) => {
  ...
  function getNextTick() {
    ...
    else if (globalThis.queueMicrotask) nextTick = globalThis.queueMicrotask;
    else if (globalThis.setImmediate) nextTick = globalThis.setImmediate;
    else nextTick = globalThis.setTimeout;
    return nextTick;
  }
  ...
  module.exports = function (
    ...
    if (typeof digest === "function") ((callback = digest), (digest = void 0));
    if (
      (checkParameters(iterations, keylen),
      (password = toBuffer(password, defaultEncoding, "Password")),
      (salt = toBuffer(salt, defaultEncoding, "Salt")),
...
var require_pbkdf2 = __commonJS((exports) => {
  ...
  function nativePBKDF2Sync(password, salt, iterations, keylen, digest) {
    return (
      ...
      (salt = toBuffer(salt, defaultEncoding, "Salt")),
      (digest = digest || "sha1"),
      nativeImpl.pbkdf2Sync(password, salt, iterations, keylen, digest)
    );
  }
  if (
    !nativeImpl.pbkdf2Sync ||
    nativeImpl.pbkdf2Sync.toString().indexOf("keylen, digest") === -1
  )
  ...
  (function (module2, exports2) {
    ...
    function BN(number, base, endian) {
      ...
      if (
        ...
        if (base === "le" || base === "be") ((endian = base), (base = 10));
        this._init(number || 0, base || 10, endian || "be");
      }
    }
    if (typeof module2 === "object") module2.exports = BN;
    else exports2.BN = BN;
    ((BN.BN = BN), (BN.wordSize = 26));
    var Buffer2;
    try {
      if (typeof window < "u" && typeof window.Buffer < "u")
        Buffer2 = window.Buffer;
      else Buffer2 = require("buffer").Buffer;
    } catch (e) {}
    ((BN.isBN = function (num) {
      if (num instanceof BN) return !0;
      return (
        num !== null &&
        typeof num === "object" &&
      ...
      (BN.prototype._init = function (number, base, endian) {
        ...
        var start = 0;
        if (number[0] === "-") (start++, (this.negative = 1));
      ...
      (BN.prototype._initNumber = function (number, base, endian) {
        if (number < 0) ((this.negative = 1), (number = -number));
        if (number < 67108864)
    ...
    function parseBase(str, start, end, mul) {
      var r = 0,
        len = Math.min(str.length, end);
      for (var i = start; i < len; i++) {
        var c = str.charCodeAt(i) - 48;
        if (((r *= mul), c >= 49)) r += c - 49 + 10;
      ...
      ((BN.prototype.toString = function (base, padding) {
        ...
        if (base === 16 || base === "hex") {
          ...
          for (var i = 0; i < this.length; i++) {
            ...
            if (
              ((carry = (w >>> (24 - off)) & 16777215), (off += 2), off >= 26)
            )
              ((off -= 26), i--);
    ...
    ((BN.prototype.zeroBits = function () {
      ...
      (BN.prototype.iuxor = function (num) {
        var a, b;
        if (this.length > num.length) ((a = this), (b = num));
        else ((a = num), (b = this));
        for (var i = 0; i < b.length; i++)
      ...
      (BN.prototype.inotn = function (width) {
        ...
        var bytesNeeded = Math.ceil(width / 26) | 0,
          bitsLeft = width % 26;
        if ((this._expand(bytesNeeded), bitsLeft > 0)) bytesNeeded--;
    ...
    ((FFTM.prototype.makeRBT = function (N) {
      ...
      (FFTM.prototype.revBin = function (x, l, N) {
        ...
        var rb = 0;
        for (var i = 0; i < l; i++) ((rb |= (x & 1) << (l - i - 1)), (x >>= 1));
        return rb;
      }),
      ...
      (FFTM.prototype.normalize13b = function (ws, N) {
        ...
        for (var i = 0; i < N / 2; i++) {
          var w =
            ...
            Math.round(ws[2 * i] / N) +
            carry;
          if (((ws[i] = w & 67108863), w < 67108864)) carry = 0;
      ...
      (BN.prototype.mul = function (num) {
        var out = new BN(null);
        return (
          (out.words = Array(this.length + num.length)),
          this.mulTo(num, out)
        );
      }),
      ...
      (BN.prototype._wordDiv = function (num, mode) {
        ...
        if (q) q.strip();
        if ((a.strip(), mode !== "div" && shift !== 0)) a.iushrn(shift);
      ...
      (BN.prototype.egcd = function (p) {
        ...
        var A = new BN(1),
          ...
          D = new BN(1),
          g = 0;
        while (x.isEven() && y.isEven()) (x.iushrn(1), y.iushrn(1), ++g);
        var yp = y.clone(),
          xp = x.clone();
        while (!x.isZero()) {
          for (
          ...
          if (i > 0) {
            x.iushrn(i);
            while (i-- > 0) {
              if (A.isOdd() || B.isOdd()) (A.iadd(yp), B.isub(xp));
          ...
          if (j > 0) {
            y.iushrn(j);
            while (j-- > 0) {
              if (C.isOdd() || D.isOdd()) (C.iadd(yp), D.isub(xp));
              (C.iushrn(1), D.iushrn(1));
            }
          }
          if (x.cmp(y) >= 0) (x.isub(y), A.isub(C), B.isub(D));
          else (y.isub(x), C.isub(A), D.isub(B));
        }
      ...
      (BN.prototype._invmp = function (p) {
        ...
        while (a.cmpn(1) > 0 && b.cmpn(1) > 0) {
          ...
          if (a.cmp(b) >= 0) (a.isub(b), x1.isub(x2));
          else (b.isub(a), x2.isub(x1));
        }
        var res;
    ...
    ((MPrime.prototype._tmp = function () {
      ...
      (MPrime.prototype.ireduce = function (num) {
        ...
        if (cmp === 0) ((r.words[0] = 0), (r.length = 1));
    ...
    (inherits(K256, MPrime),
      ...
      (K256.prototype.imulK = function (num) {
        ...
        if (num.words[num.length - 1] === 0) {
          if ((num.length--, num.words[num.length - 1] === 0)) num.length--;
        }
        return num;
      }));
    function P224() {
    ...
    ((Red.prototype._verify1 = function (a) {
      ...
      (Red.prototype.sqrt = function (a) {
        ...
        var q = this.m.subn(1),
          s = 0;
        while (!q.isZero() && q.andln(1) === 0) (s++, q.iushrn(1));
        assert(!q.isZero());
...
var require_utils = __commonJS((exports) => {
  ...
  function toArray(msg, enc) {
    ...
    if (enc === "hex") {
      if (((msg = msg.replace(/[^a-z0-9]+/gi, "")), msg.length % 2 !== 0))
        msg = "0" + msg;
  ...
  function getJSF(k1, k2) {
    ...
    while (k1.cmpn(-d1) > 0 || k2.cmpn(-d2) > 0) {
      ...
      if ((m14 & 1) === 0) u1 = 0;
        ...
        ((m8 = (k1.andln(7) + d1) & 7), (m8 === 3 || m8 === 5) && m24 === 2)
      )
        u1 = -m14;
      else u1 = m14;
      jsf[0].push(u1);
      ...
      if ((m24 & 1) === 0) u2 = 0;
        ...
        ((m8 = (k2.andln(7) + d2) & 7), (m8 === 3 || m8 === 5) && m14 === 2)
      )
        u2 = -m24;
      else u2 = m24;
      if ((jsf[1].push(u2), 2 * d1 === u1 + 1)) d1 = 1 - d1;
...
var require_base = __commonJS((exports, module) => {
  ...
  function BaseCurve(type, conf) {
    ...
    else ((this._maxwellTrick = !0), (this.redN = this.n.toRed(this.red)));
  }
  ...
  BaseCurve.prototype._fixedNafMul = function (p, k) {
    ...
    for (var i = I; i > 0; i--) {
      for (j = 0; j < repr.length; j++)
        if (((nafW = repr[j]), nafW === i)) b = b.mixedAdd(doubles.points[j]);
  ...
  BaseCurve.prototype._wnafMulAdd = function (
    ...
    for (i = max; i >= 0; i--) {
      ...
      while (i >= 0) {
        var zero = !0;
        for (j = 0; j < len; j++)
          if (((tmp[j] = naf[j][i] | 0), tmp[j] !== 0)) zero = !1;
        if (!zero) break;
        (k++, i--);
      }
      if (i >= 0) k++;
      if (((acc = acc.dblp(k)), i < 0)) break;
      for (j = 0; j < len; j++) {
        var z = tmp[j];
        if (z === 0) continue;
...
var require_short = __commonJS((exports, module) => {
  ...
  ShortCurve.prototype._getEndoBasis = function (lambda) {
    ...
    if (len2.cmp(len1) >= 0) ((a2 = a0), (b2 = b0));
  ...
  ShortCurve.prototype.pointFromX = function (x, odd) {
    if (((x = new BN(x, 16)), !x.red)) x = x.toRed(this.red);
  ...
  ShortCurve.prototype._endoWnafMulAdd = function (
    ...
    for (var i = 0; i < points.length; i++) {
      var split = this._endoSplit(coeffs[i]),
        p = points[i],
        beta = p._getBeta();
      if (split.k1.negative) (split.k1.ineg(), (p = p.neg(!0)));
      if (split.k2.negative) (split.k2.ineg(), (beta = beta.neg(!0)));
      ((npoints[i * 2] = p),
        (npoints[i * 2 + 1] = beta),
    ...
    for (var j = 0; j < i * 2; j++) ((npoints[j] = null), (ncoeffs[j] = null));
    return res;
  };
  ...
  Point.prototype.mul = function (k) {
    if (((k = new BN(k, 16)), this.isInfinity())) return this;
  ...
  Point.prototype.jmulAdd = function (k1, p2, k2) {
    var points = [this, p2],
      coeffs = [k1, k2];
    if (this.curve.endo) return this.curve._endoWnafMulAdd(points, coeffs, !0);
    else return this.curve._wnafMulAdd(1, points, coeffs, 2, !0);
  };
...
var require_mont = __commonJS((exports, module) => {
  ...
  function Point(curve, x, z) {
    if (
      (Base.BasePoint.call(this, curve, "projective"), x === null && z === null)
    )
  ...
  Point.prototype.mul = function (k) {
    ...
    for (var i = bits.length - 1; i >= 0; i--)
      if (bits[i] === 0) ((a = a.diffAdd(b, c)), (b = b.dbl()));
      else ((b = a.diffAdd(b, c)), (a = a.dbl()));
    return b;
  };
...
var require_edwards = __commonJS((exports, module) => {
  ...
  EdwardsCurve.prototype.pointFromY = function (y, odd) {
    if (((y = new BN(y, 16)), !y.red)) y = y.toRed(this.red);
    var y2 = y.redSqr(),
...
var require_utils3 = __commonJS((exports) => {
  ...
  function isSurrogatePair(msg, i) {
    if ((msg.charCodeAt(i) & 64512) !== 55296) return !1;
...
var require_common = __commonJS((exports) => {
  ...
  BlockHash.prototype.update = function (msg, enc) {
    if (((msg = utils.toArray(msg, enc)), !this.pending)) this.pending = msg;
...
var require_key = __commonJS((exports, module) => {
  ...
  KeyPair.prototype.validate = function () {
    ...
    if (pub.isInfinity()) return { result: !1, reason: "Invalid public key" };
    if (!pub.validate())
  ...
  KeyPair.prototype.getPublic = function (compact, enc) {
    if (typeof compact === "string") ((enc = compact), (compact = null));
  ...
  KeyPair.prototype.verify = function (msg, signature, options) {
...
var require_signature = __commonJS((exports, module) => {
  ...
  Signature.prototype._importDER = function (data, enc) {
    ...
    if (rlen === !1) return !1;
    if ((data[p.place] & 128) !== 0) return !1;
...
var require_ec = __commonJS((exports, module) => {
  ...
  EC.prototype.sign = function (msg, key, enc, options) {
    if (typeof enc === "object") ((options = enc), (enc = null));
    if (!options) options = {};
    ...
    for (var iter = 0; ; iter++) {
      ...
      if (((s = s.umod(this.n)), s.cmpn(0) === 0)) continue;
      var recoveryParam =
...
var require_signature2 = __commonJS((exports, module) => {
  ...
  function Signature(eddsa, sig) {
    if (((this.eddsa = eddsa), typeof sig !== "object")) sig = parseBytes(sig);
    ...
    if (
      (assert(sig.R && sig.S, "Signature without R or S"), eddsa.isPoint(sig.R))
    )
      this._R = sig.R;
...
var require_eddsa = __commonJS((exports, module) => {
  ...
  EDDSA.prototype.verify = function (message, sig, pub) {
    if (
      ...
      sig.S().gte(sig.eddsa.curve.n) || sig.S().isNeg())
    )
      return !1;
...
var require_reporter = __commonJS((exports) => {
  ...
  Reporter.prototype.leaveKey = function (index, key, value) {
    var state = this._reporterState;
    if ((this.exitKey(index), state.obj !== null)) state.obj[key] = value;
  };
...
var require_buffer = __commonJS((exports) => {
  var inherits = require_inherits(),
    Reporter = require_base2().Reporter,
...
var require_node = __commonJS((exports, module) => {
  var Reporter = require_base2().Reporter,
    EncoderBuffer = require_base2().EncoderBuffer,
    DecoderBuffer = require_base2().DecoderBuffer,
    assert = require_minimalistic_assert(),
    tags = [
      "seq",
      "seqof",
  ...
  Node.prototype.obj = function () {
    var state = this._baseState,
      args = Array.prototype.slice.call(arguments);
    if (((state.obj = !0), args.length !== 0)) this._useArgs(args);
    return this;
  };
  ...
  Node.prototype._decode = function (input, options) {
    ...
    if (present) {
      ...
      if (
        ...
        result = this._getUse(state.contains, input._reporterState.obj)._decode(
          data,
          options,
        );
      }
  ...
  Node.prototype._encodeValue = function (data, reporter, parent) {
    ...
    else ((content = this._encodePrimitive(state.tag, data)), (primitive = !0));
    var result;
  ...
  Node.prototype._encodePrimitive = function (tag, data) {
    ...
    else throw Error("Unsupported tag: " + tag);
  };
...
var require_pem = __commonJS((exports, module) => {
  ...
  PEMDecoder.prototype.decode = function (data, options) {
    ...
    if (start === -1 || end === -1)
      throw Error("PEM section not found for: " + label);
...
var require_der3 = __commonJS((exports, module) => {
  ...
  DERNode.prototype._encodeInt = function (num, values) {
    ...
    if (Buffer2.isBuffer(num)) {
      ...
      if ((num.copy(out), num.length === 0)) out[0] = 0;
  ...
  DERNode.prototype._skipDefault = function (dataBuffer, reporter, parent) {
    ...
    if (data.length !== state.defaultBuffer.length) return !1;
...
var require_hash_base = __commonJS((exports, module) => {
  ...
  var useUint8Array = typeof Uint8Array < "u",
    useArrayBuffer =
...
var require_evp_bytestokey = __commonJS((exports, module) => {
  ...
  function EVP_BytesToKey(password, salt, keyBits, ivLen) {
    ...
    while (keyLen > 0 || ivLen > 0) {
      var hash = new MD5();
      if ((hash.update(tmp), hash.update(password), salt)) hash.update(salt);
      tmp = hash.digest();
      var used = 0;
      if (keyLen > 0) {
...
var require_fixProc = __commonJS((exports, module) => {
  var findProc =
    ...
    ciphers = require_browserify_aes(),
    Buffer2 = require_safe_buffer().Buffer;
...
var require_parse_asn1 = __commonJS((exports, module) => {
  var asn1 = require_asn12(),
    ...
    ciphers = require_browserify_aes(),
    pbkdf2Sync = require_pbkdf2().pbkdf2Sync,
    Buffer2 = require_safe_buffer().Buffer;
...
var require_bn5 = __commonJS((exports, module) => {
  (function (module2, exports2) {
    ...
    function parseHex4Bits(string, index) {
      ...
      else assert(!1, "Invalid character in " + string);
    }
    function parseHexByte(string, lowerBound, index) {
      var r = parseHex4Bits(string, index);
      if (index - 1 >= lowerBound) r |= parseHex4Bits(string, index - 1) << 4;
    ...
    ((FFTM.prototype.makeRBT = function (N) {
      ...
      (BN.prototype._wordDiv = function (num, mode) {
        ...
        if (q) q._strip();
        if ((a._strip(), mode !== "div" && shift !== 0)) a.iushrn(shift);
        return { div: q || null, mod: a };
      }),
      (BN.prototype.divmod = function (num, mode, positive) {
        if ((assert(!num.isZero()), this.isZero()))
...
var require_browserify_rsa = __commonJS((exports, module) => {
  var BN = require_bn5(),
    randomBytes = require_randombytes(),
    Buffer2 = require_safe_buffer().Buffer;
  function getr(priv) {
...
var require_publicEncrypt = __commonJS((exports, module) => {
  var parseKeys = require_parse_asn1(),
    randomBytes = require_randombytes(),
    createHash = require_create_hash(),
    mgf = require_mgf(),
    xor = require_xor(),
    BN = require_bn4(),
  ...
  function pkcs1(key, msg, reverse) {
    ...
    var ps;
    if (reverse) ps = Buffer2.alloc(k - mLen - 3, 255);
  ...
  function nonZero(len) {
    var out = Buffer2.allocUnsafe(len),
      ...
      num;
    while (i < len) {
      if (cur === cache.length) ((cache = randomBytes(len * 2)), (cur = 0));
      if (((num = cache[cur++]), num)) out[i++] = num;
    }
    return out;
  }
});
var require_privateDecrypt = __commonJS((exports, module) => {
  ...
  function oaep(key, msg) {
    ...
    if (compare(iHash, db.slice(0, hLen))) throw Error("decryption error");
    var i = hLen;
    while (db[i] === 0) i++;
    if (db[i++] !== 1) throw Error("decryption error");
    return db.slice(i);
  }
  function pkcs1(key, msg, reverse) {
    ...
    if (status) throw Error("decryption error");
    return msg.slice(i);
  }
  function compare(a, b) {
    ...
    var dif = 0,
      len = a.length;
    if (a.length !== b.length) (dif++, (len = Math.min(a.length, b.length)));
    var i = -1;
...
var require_public_encrypt = __commonJS((exports) => {
  var crypto2 = require("crypto");
  if (typeof crypto2.publicEncrypt !== "function") crypto2 = require_browser2();
  ...
  else exports.privateEncrypt = crypto2.privateEncrypt;
  if (typeof crypto2.publicDecrypt !== "function")
    exports.publicDecrypt = require_browser2().publicDecrypt;
  else exports.publicDecrypt = crypto2.publicDecrypt;
});
var require_browser3 = __commonJS((exports) => {
  var safeBuffer = require_safe_buffer(),
    ...
    crypto2 = globalThis.crypto || globalThis.msCrypto,
...
var require_randomfill = __commonJS((exports, module) => {
  var crypto2 = require("crypto");
  if (
    typeof crypto2.randomFill === "function" &&
    typeof crypto2.randomFillSync === "function"
  )
    ((exports.randomFill = crypto2.randomFill),
      (exports.randomFillSync = crypto2.randomFillSync));
  else module.exports = require_browser3();
});
...
var cryptoBrowserify = __toESM(require_crypto_browserify(), 1),
...
export {
  ...
  createDecipher2 as createDecipher,
  createCredentials2 as createCredentials,
  createCipheriv2 as createCipheriv,
  createCipher2 as createCipher,
