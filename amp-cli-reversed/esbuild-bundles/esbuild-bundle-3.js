...
var __require = "";
var require_capability = __commonJS((exports) => {
  exports.fetch =
    isFunction(globalThis.fetch) && isFunction(globalThis.ReadableStream);
  ...
  function getXHR() {
    ...
    if (globalThis.XMLHttpRequest) {
      ...
      try {
        xhr.open(
          "GET",
          globalThis.XDomainRequest ? "/" : "https://example.com",
        );
      } catch (e) {
        xhr = null;
      }
  ...
  exports.overrideMimeType =
    exports.fetch || (getXHR() ? isFunction(getXHR().overrideMimeType) : !1);
        ...
        },
        {
          ...
          value: function (n) {
            ...
            while ((p = p.next)) {
              ...
              if (((n -= nb), n === 0)) {
                if (nb === str.length)
                  if ((++c, p.next)) this.head = p.next;
                  else this.head = this.tail = null;
                else ((this.head = p), (p.data = str.slice(nb)));
                break;
              }
              ++c;
            }
          ...
          value: function (n) {
            ...
            while ((p = p.next)) {
              ...
              if ((buf.copy(ret, ret.length - n, 0, nb), (n -= nb), n === 0)) {
                ...
                else ((this.head = p), (p.data = buf.slice(nb)));
                break;
              }
              ++c;
            }
  ...
  function destroy(err, cb) {
    ...
    return (
      this._destroy(err || null, function (err2) {
        ...
        else if (cb) (process.nextTick(emitCloseNT, _this), cb(err2));
        else process.nextTick(emitCloseNT, _this);
      }),
      this
    );
...
var require_errors = __commonJS((exports, module) => {
  ...
  function oneOf(expected, thing) {
    if (Array.isArray(expected)) {
      ...
      if (((expected = expected.map((i) => String(i))), len > 2))
        return (
  ...
  function includes(str, search, start) {
    ...
    if (start + search.length > str.length) return !1;
...
var require__stream_writable = __commonJS((exports, module) => {
  ...
  var destroyImpl = require_destroy(),
    _require = require_state(),
    getHighWaterMark = _require.getHighWaterMark,
    _require$codes = require_errors().codes,
  ...
  function WritableState(options, stream, isDuplex) {
    ...
    ((this.decodeStrings = !noDecode),
      ...
      (this.prefinished = !1),
      (this.errorEmitted = !1),
      (this.emitClose = options.emitClose !== !1),
  ...
  WritableState.prototype.getBuffer = function () {
    var current = this.bufferedRequest,
      out = [];
    while (current) (out.push(current), (current = current.next));
    return out;
  };
  (function () {
    try {
  ...
  function validChunk(stream, state, chunk, cb) {
    ...
    if (er) return (errorOrDestroy(stream, er), process.nextTick(cb, er), !1);
    return !0;
  }
  ...
  function clearBuffer(stream, state) {
    ...
    if (stream._writev && entry && entry.next) {
      ...
      var count = 0,
        allBuffers = !0;
      while (entry) {
        if (((buffer[count] = entry), !entry.isBuf)) allBuffers = !1;
      ...
      while (entry) {
        var { chunk, encoding, callback: cb } = entry,
  ...
  function callFinal(stream, state) {
    stream._final(function (err) {
      if ((state.pendingcb--, err)) errorOrDestroy(stream, err);
      ((state.prefinished = !0),
  ...
  function prefinish(stream, state) {
    if (!state.prefinished && !state.finalCalled)
      ...
      else ((state.prefinished = !0), stream.emit("prefinish"));
  }
  function finishMaybe(stream, state) {
    var need = needFinish(state);
    if (need) {
      if ((prefinish(stream, state), state.pendingcb === 0)) {
        if (((state.finished = !0), stream.emit("finish"), state.autoDestroy)) {
  ...
  Object.defineProperty(Writable.prototype, "destroyed", {
    enumerable: !1,
    get: function () {
      if (this._writableState === void 0) return !1;
...
var require__stream_duplex = __commonJS((exports, module) => {
  ...
  function Duplex(options) {
    ...
    if (
      ...
      if (options.readable === !1) this.readable = !1;
      if (options.writable === !1) this.writable = !1;
      if (options.allowHalfOpen === !1)
...
var require_string_decoder = __commonJS((exports) => {
  var Buffer2 = require_safe_buffer().Buffer,
    isEncoding =
      ...
      function (encoding) {
        switch (
          ((encoding = "" + encoding), encoding && encoding.toLowerCase())
        ) {
          case "hex":
          case "utf8":
          case "utf-8":
...
var require_end_of_stream = __commonJS((exports, module) => {
  ...
  function eos(stream, opts, callback) {
    ...
    var readable = opts.readable || (opts.readable !== !1 && stream.readable),
      writable = opts.writable || (opts.writable !== !1 && stream.writable),
      onlegacyfinish = function () {
        if (!stream.writable) onfinish();
      },
      writableEnded = stream._writableState && stream._writableState.finished,
      onfinish = function () {
        if (((writable = !1), (writableEnded = !0), !readable))
          callback.call(stream);
      },
      readableEnded = stream._readableState && stream._readableState.endEmitted,
      onend = function () {
        if (((readable = !1), (readableEnded = !0), !writable))
          callback.call(stream);
      },
...
var require_async_iterator = __commonJS((exports, module) => {
  ...
  var AsyncIteratorPrototype = Object.getPrototypeOf(function () {}),
          ...
          if (this[kStream].destroyed)
            return new Promise(function (resolve, reject) {
              process.nextTick(function () {
                ...
                else resolve(createIterResult(void 0, !0));
              });
            });
    ...
    createReadableStreamAsyncIterator = function (stream) {
      var _Object$create,
...
var require_from = __commonJS((exports, module) => {
  ...
  function from(Readable, iterable, opts) {
    ...
    var readable = new Readable(_objectSpread({ objectMode: !0 }, opts)),
      reading = !1;
    readable._read = function () {
      if (!reading) ((reading = !0), next());
    };
    function next() {
...
var require__stream_readable = __commonJS((exports, module) => {
  ...
  Object.defineProperty(Readable.prototype, "destroyed", {
    enumerable: !1,
    get: function () {
      if (this._readableState === void 0) return !1;
  ...
  function readableAddChunk(
    ...
    if (chunk === null) ((state.reading = !1), onEofChunk(stream, state));
    else {
      var er;
  ...
  Readable.prototype.setEncoding = function (enc) {
    ...
    var p = this._readableState.buffer.head,
      content = "";
    while (p !== null) ((content += decoder.write(p.data)), (p = p.next));
  ...
  function howMuchToRead(n, state) {
    ...
    if (!state.ended) return ((state.needReadable = !0), 0);
    return state.length;
  }
  Readable.prototype.read = function (n) {
    ...
    var state = this._readableState,
      nOrig = n;
    if (n !== 0) state.emittedReadable = !1;
    if (
      n === 0 &&
      state.needReadable &&
    ...
    if (
      ...
      state.length === 0 || state.length - n < state.highWaterMark)
    )
    ...
    else ((state.length -= n), (state.awaitDrain = 0));
    if (state.length === 0) {
  ...
  function onEofChunk(stream, state) {
    ...
    if (((state.ended = !0), state.sync)) emitReadable(stream);
    else if (((state.needReadable = !1), !state.emittedReadable))
  ...
  function emitReadable_(stream) {
    ...
    if (
      ...
      !state.destroyed && (state.length || state.ended))
    )
...
var require_pipeline = __commonJS((exports, module) => {
  ...
  function once(callback) {
    ...
    return function () {
      if (called) return;
      ((called = !0), callback.apply(void 0, arguments));
    };
  }
  var _require$codes = require_errors().codes,
  ...
  function pipeline() {
    for (
      var _len = arguments.length, streams = Array(_len), _key = 0;
      _key < _len;
      _key++
    )
    ...
    var error,
      destroys = streams.map(function (stream, i) {
...
var require_response = __commonJS((exports) => {
  var capability = require_capability(),
    ...
    IncomingMessage = (exports.IncomingMessage = function (
      xhr,
      response,
      mode,
      resetTimers,
        ...
        let read2 = function () {
          reader
            ...
            .then(function (result) {
              ...
              (self2.push(Buffer.from(result.value)), read2());
            })
            .catch(function (err) {
              if ((resetTimers(!0), !self2._destroyed))
                self2.emit("error", err);
            });
        };
        var read = read2;
            ...
            write: function (chunk) {
              return (
                ...
                new Promise(function (resolve, reject) {
                  if (self2._destroyed) reject();
                  else if (self2.push(Buffer.from(chunk))) resolve();
                  else self2._resumeFetch = resolve;
                })
              );
            },
            close: function () {
              if ((resetTimers(!0), !self2._destroyed)) self2.push(null);
            },
            abort: function (err) {
              if ((resetTimers(!0), !self2._destroyed))
                self2.emit("error", err);
        ...
        if (
          (headers.forEach(function (header) {
            ...
            if (matches) {
              ...
              if (key === "set-cookie") {
                if (self2.headers[key] === void 0) self2.headers[key] = [];
                self2.headers[key].push(matches[2]);
              } else if (self2.headers[key] !== void 0)
                self2.headers[key] += ", " + matches[2];
              else self2.headers[key] = matches[2];
          ...
          if (mimeType) {
            ...
            if (charsetMatch) self2._charset = charsetMatch[1].toLowerCase();
          }
  ...
  IncomingMessage.prototype._read = function () {
    var self2 = this,
      resolve = self2._resumeFetch;
    if (resolve) ((self2._resumeFetch = null), resolve());
  };
  IncomingMessage.prototype._onXHRProgress = function (resetTimers) {
    ...
    switch (self2._mode) {
      case "text":
        if (((response = xhr.responseText), response.length > self2._pos)) {
          ...
          if (self2._charset === "x-user-defined") {
            ...
            self2.push(buffer);
          } else self2.push(newData, self2._charset);
      ...
      case "moz-chunked-arraybuffer":
        if (
          ((response = xhr.response),
          xhr.readyState !== rStates.LOADING || !response)
        )
          break;
        self2.push(Buffer.from(new Uint8Array(response)));
        break;
      case "ms-stream":
        ...
        ((reader.onprogress = function () {
          if (reader.result.byteLength > self2._pos)
            (self2.push(
              Buffer.from(new Uint8Array(reader.result.slice(self2._pos))),
            ),
              (self2._pos = reader.result.byteLength));
        }),
          (reader.onload = function () {
            (resetTimers(!0), self2.push(null));
          }),
...
var require_request = __commonJS((exports, module) => {
  ...
  var ClientRequest = (module.exports = function (opts) {
    ...
    if (
      ...
      ((useFetch = !1), (preferBinary = !0));
    else if (opts.mode === "prefer-streaming") preferBinary = !1;
      ...
      preferBinary = !0;
    else throw Error("Invalid value for opts.mode");
  ...
  ClientRequest.prototype._onFinish = function () {
    ...
    if ("timeout" in opts && opts.timeout !== 0) self2.setTimeout(opts.timeout);
    ...
    if (
      ...
      if (capability.abortController) {
        ...
        if (
          ...
          "requestTimeout" in opts && opts.requestTimeout !== 0)
        )
        ...
        .then(
          function (response2) {
            ((self2._fetchResponse = response2),
              self2._resetTimers(!1),
              self2._connect());
          },
          function (reason) {
            if ((self2._resetTimers(!0), !self2._destroyed))
      ...
      try {
        xhr.open(self2._opts.method, self2._opts.url, !0);
      } catch (err) {
        process.nextTick(function () {
          self2.emit("error", err);
        });
      ...
      xhr.onerror = function () {
        if (self2._destroyed) return;
        (self2._resetTimers(!0), self2.emit("error", Error("XHR error")));
      };
      try {
        xhr.send(body);
      } catch (err) {
  ...
  ClientRequest.prototype._onXHRProgress = function () {
    var self2 = this;
    if ((self2._resetTimers(!1), !statusValid(self2._xhr) || self2._destroyed))
      return;
  ...
  ClientRequest.prototype._connect = function () {
    var self2 = this;
    if (self2._destroyed) return;
    ((self2._response = new IncomingMessage(
      self2._xhr,
      self2._fetchResponse,
      self2._mode,
      self2._resetTimers.bind(self2),
    )),
  ...
  ClientRequest.prototype.abort = ClientRequest.prototype.destroy = function (
    ...
    var self2 = this;
    if (((self2._destroyed = !0), self2._resetTimers(!0), self2._response))
      self2._response._destroyed = !0;
...
var require_builtin_status_codes = __commonJS((exports, module) => {
  module.exports = require("http").STATUS_CODES;
});
var require_stream_http = __commonJS((exports) => {
  var ClientRequest = require_request(),
    response = require_response(),
    extend = require_immutable(),
    statusCodes = require_builtin_status_codes(),
    url = require("url"),
    http = exports;
...
var import_stream_http = __toESM(require_stream_http(), 1),
  {
    request,
    get,
    ClientRequest,
