...
// Module: iuR (CJS)
(T)=>{Object.defineProperty(T,"__esModule",{value:!0}),T.boolOrEmptySchema=T.topBoolOrEmptySchema=void 0;
var R=vN(),a=M9(),e=Oc(),t={message:"boolean schema is false"};
function r(c){let{gen:s,schema:A,validateName:l}=c;
if(A===!1)i(c,!1);
