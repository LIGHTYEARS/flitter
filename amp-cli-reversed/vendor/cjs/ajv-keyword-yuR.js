  ...
  var R = M9(),
    ...
    t = {
      message: ({ keyword: h, schemaCode: i }) =>
        R.str`must be ${e[h].okStr} ${i}`,
      params: ({ keyword: h, schemaCode: i }) =>
        R._`{comparison: ${e[h].okStr}, limit: ${i}}`,
    },
    r = {
      ...
      error: t,
      code(h) {
        let { keyword: i, data: c, schemaCode: s } = h;
        h.fail$data(R._`${c} ${e[i].fail} ${s} || isNaN(${c})`);
      },
    };
  T.default = r;
};
