// Module: batch-log-record-processor-4
// Original: rtR
// Type: CJS (RT wrapper)
// Exports: BatchLogRecordProcessor
// Category: util

// Module: RtR (CJS)
(T) => {
  (Object.defineProperty(T, "__esModule", { value: !0 }),
    (T.ConsoleLogRecordExporter = void 0));
  var R = $9();
  class a {
    export(e, t) {
    ...
    _exportInfo(e) {
      return {
        ...
        timestamp: (0, R.hrTimeToMicroseconds)(e.hrTime),
    ...
    _sendLogRecords(e, t) {
      ...
      t?.({ code: R.ExportResultCode.SUCCESS });
    }
  }
  T.ConsoleLogRecordExporter = a;
};
