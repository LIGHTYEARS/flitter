...
(T) => {
  (Object.defineProperty(T, "__esModule", { value: !0 }),
    (T.createDenyListAttributesProcessor =
      ...
      T.createMultiAttributesProcessor =
      T.createNoopAttributesProcessor =
        void 0));
  class R {
    process(A, l) {
      return A;
  ...
  class e {
    ...
    process(A, l) {
      ...
      return (
        Object.keys(A)
          .filter((n) => this._allowedAttributeNames.includes(n))
          .forEach((n) => (o[n] = A[n])),
        o
      );
    }
  ...
  class t {
    ...
    process(A, l) {
      ...
      return (
        Object.keys(A)
          .filter((n) => !this._deniedAttributeNames.includes(n))
          .forEach((n) => (o[n] = A[n])),
        o
      );
    }
  ...
  T.createNoopAttributesProcessor = r;
  function h(A) {
    return new a(A);
  }
  T.createMultiAttributesProcessor = h;
  function i(A) {
    return new e(A);
  }
  T.createAllowListAttributesProcessor = i;
  function c(A) {
    return new t(A);
  }
  T.createDenyListAttributesProcessor = c;
  var s = new R();
};
