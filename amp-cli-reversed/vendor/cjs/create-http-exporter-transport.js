// Module: create-http-exporter-transport
// Original: OrR
// Type: CJS (RT wrapper)
// Exports: createHttpExporterTransport
// Category: util
...
(T, R) => {
  ...
  function e(t, r, h) {
    ...
    (a.EventEmitter.call(this),
      ...
      (this.responseDelimited = Boolean(h)));
  }
  ((e.prototype.rpcCall = function t(r, h, i, c, s) {
    ...
    try {
      return A.rpcImpl(
        r,
        h[A.requestDelimited ? "encodeDelimited" : "encode"](c).finish(),
        function (l, o) {
          if (l) return (A.emit("error", l, r), s(l));
          if (o === null) {
            A.end(!0);
            return;
          }
          if (!(o instanceof i))
            try {
              ...
              return (A.emit("error", n, r), s(n));
            }
          return (A.emit("data", o, r), s(null, o));
        },
      );
    } catch (l) {
      (A.emit("error", l, r),
