// Module: disable-instrumentations
// Original: LaR
// Type: CJS (RT wrapper)
// Exports: disableInstrumentations, enableInstrumentations
// Category: util

// Module: laR (CJS)
(T)=>{Object.defineProperty(T,"__esModule",{value:!0}),T.TraceStateImpl=void 0;
var R=naR(),a=32,e=512,t=",",r="=";
class h{constructor(i){if(this._internalState=new Map,i)this._parse(i)}set(i,c){let s=this._clone();
...
return i._internalState=new Map(this._internalState),i}}T.TraceStateImpl=h}