// Module: exact-predicate
// Original: uZ
// Type: CJS (RT wrapper)
// Exports: ExactPredicate, PatternPredicate
// Category: util
...
(T) => {
  ...
  class a {
    ...
    _regexp;
    constructor(t) {
      if (t === "*") ((this._matchAll = !0), (this._regexp = /.*/));
      else
        ((this._matchAll = !1),
          (this._regexp = new RegExp(a.escapePattern(t))));
    }
    match(t) {
