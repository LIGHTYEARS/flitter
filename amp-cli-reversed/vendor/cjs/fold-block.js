...
` &&
        ...
        if (y >= p)
          if (_) (o.push(_), (p = _ + l), (_ = void 0));
          else if (r === "quoted") {
            while (m === " " || m === "\t")
              ((m = x), (x = e[(y += 1)]), (b = !0));
            let f = y > P + 1 ? y - 2 : u - 1;
            if (n[f]) return e;
            (o.push(f), (n[f] = !0), (p = f + l), (_ = void 0));
          } else b = !0;
      }
      m = x;
    }
