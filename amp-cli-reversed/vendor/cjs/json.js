...
(T) => {
  ...
  (Object.defineProperty(T, "__esModule", { value: !0 }),
    (T.req = T.json = T.toBuffer = void 0));
  var t = e(qT("http")),
    r = e(qT("https"));
  async function h(s) {
    let A = 0,
    ...
    return Buffer.concat(l, A);
  }
  T.toBuffer = h;
  async function i(s) {
    let A = (await h(s)).toString("utf8");
    try {
      return JSON.parse(A);
    } catch (l) {
      let o = l;
      throw ((o.message += ` (input: ${A})`), o);
    }
  }
  T.json = i;
  function c(s, A = {}) {
    let l = (
        (typeof s === "string" ? s : s.href).startsWith("https:") ? r : t
      ).request(s, A),
      o = new Promise((n, p) => {
        l.once("response", n).once("error", p).end();
      });
    return ((l.then = o.then.bind(o)), l);
  }
  T.req = c;
};
