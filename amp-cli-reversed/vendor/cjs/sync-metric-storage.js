// Module: sync-metric-storage
// Original: OtR
// Type: CJS (RT wrapper)
// Exports: SyncMetricStorage
// Category: util

// Module: otR (CJS)
(T) => {
  (Object.defineProperty(T, "__esModule", { value: !0 }), (T.Buckets = void 0));
  class R {
    backing;
    indexBase;
    indexStart;
    indexEnd;
    constructor(e = new a(), t = 0, r = 0, h = 0) {
      ((this.backing = e),
        (this.indexBase = t),
        (this.indexStart = r),
        (this.indexEnd = h));
    ...
    downscale(e) {
      ...
      let t = 1 + this.indexEnd - this.indexStart,
        ...
        h = 0,
        i = 0;
      for (let c = this.indexStart; c <= this.indexEnd; ) {
        let s = c % r;
        if (s < 0) s += r;
        for (let A = s; A < r && h < t; A++)
          (this._relocateBucket(i, h), h++, c++);
        i++;
      }
      ((this.indexStart >>= e),
        (this.indexEnd >>= e),
  ...
  class a {
    ...
    growTo(e, t, r) {
      let h = Array(e).fill(0);
      (h.splice(r, this._counts.length - t, ...this._counts.slice(t)),
        h.splice(0, t, ...this._counts.slice(0, t)),
        (this._counts = h));
    }
    reverse(e, t) {
      let r = Math.floor((e + t) / 2) - e;
      for (let h = 0; h < r; h++) {
        let i = this._counts[e + h];
        ((this._counts[e + h] = this._counts[t - h - 1]),
          (this._counts[t - h - 1] = i));
      }
    }
    emptyBucket(e) {
