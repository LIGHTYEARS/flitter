...
(T, R) => {
  ...
  function h(n, p) {
    return RangeError(
      "index out of range: " + n.pos + " + " + (p || 1) + " > " + n.len,
    );
  }
  function i(n) {
  ...
  var c =
      typeof Uint8Array < "u"
        ? function (n) {
            if (n instanceof Uint8Array || Array.isArray(n)) return new i(n);
            throw Error("illegal buffer");
          }
        : function (n) {
            if (Array.isArray(n)) return new i(n);
            throw Error("illegal buffer");
          },
    s = function () {
      return a.Buffer
        ? function (n) {
            return (i.create = function (p) {
              return a.Buffer.isBuffer(p) ? new e(p) : c(p);
            })(n);
          }
        : c;
    };
  ((i.create = s()),
    ...
    (i.prototype.uint32 = (function () {
      ...
      return function () {
        if (
          ((n = (this.buf[this.pos] & 127) >>> 0), this.buf[this.pos++] < 128)
        )
          return n;
        if (
          ((n = (n | ((this.buf[this.pos] & 127) << 7)) >>> 0),
          this.buf[this.pos++] < 128)
        )
          return n;
        if (
          ((n = (n | ((this.buf[this.pos] & 127) << 14)) >>> 0),
          this.buf[this.pos++] < 128)
        )
          return n;
        if (
          ((n = (n | ((this.buf[this.pos] & 127) << 21)) >>> 0),
          this.buf[this.pos++] < 128)
        )
          return n;
        if (
          ((n = (n | ((this.buf[this.pos] & 15) << 28)) >>> 0),
          this.buf[this.pos++] < 128)
        )
          return n;
  ...
  function A() {
    ...
    if (this.len - this.pos > 4) {
      for (; p < 4; ++p)
        if (
          ((n.lo = (n.lo | ((this.buf[this.pos] & 127) << (p * 7))) >>> 0),
          this.buf[this.pos++] < 128)
        )
          return n;
      if (
        ((n.lo = (n.lo | ((this.buf[this.pos] & 127) << 28)) >>> 0),
    ...
    if (this.len - this.pos > 4) {
      for (; p < 5; ++p)
        if (
          ((n.hi = (n.hi | ((this.buf[this.pos] & 127) << (p * 7 + 3))) >>> 0),
          this.buf[this.pos++] < 128)
        )
          return n;
    } else
  ...
  function l(n, p) {
    return (
      (n[p - 4] | (n[p - 3] << 8) | (n[p - 2] << 16) | (n[p - 1] << 24)) >>> 0
    );
  }
  ...
  function o() {
    ...
    return new t(l(this.buf, (this.pos += 4)), l(this.buf, (this.pos += 4)));
  }
  ((i.prototype.float = function () {
    ...
    (i.prototype.bytes = function () {
      ...
      if (((this.pos += n), Array.isArray(this.buf)))
        return this.buf.slice(p, _);
      if (p === _) {
        var m = a.Buffer;
        return m ? m.alloc(0) : new this.buf.constructor(0);
      }
      return this._slice.call(this.buf, p, _);
    }),
    (i.prototype.string = function () {
      var n = this.bytes();
      return r.read(n, 0, n.length);
    }),
    (i.prototype.skip = function (n) {
      if (typeof n === "number") {
        ...
        do if (this.pos >= this.len) throw h(this);
        while (this.buf[this.pos++] & 128);
      return this;
    }),
    (i.prototype.skipType = function (n) {
      switch (n) {
        case 0:
          this.skip();
          break;
        ...
        case 2:
          ...
          break;
        case 3:
          while ((n = this.uint32() & 7) !== 4) this.skipType(n);
          break;
        case 5:
          this.skip(4);
          break;
