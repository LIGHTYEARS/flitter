...
// Module: im (CJS)
(T, R) => {
  ((R.exports = c), (c.className = "ReflectionObject"));
  var a = px(),
    e = Fe(),
    t,
    r = {
  ...
  function c(s, A) {
    if (!e.isString(s)) throw TypeError("name must be a string");
  ...
  (Object.defineProperties(c.prototype, {
    ...
    (c.prototype.onAdd = function (s) {
      if (this.parent && this.parent !== s) this.parent.remove(this);
      ((this.parent = s), (this.resolved = !1));
      var A = s.root;
      if (A instanceof t) A._handleAdd(this);
    }),
    (c.prototype.onRemove = function (s) {
      var A = s.root;
    ...
    (c.prototype._resolveFeaturesRecursive = function (s) {
      return this._resolveFeatures(this._edition || s);
    }),
    (c.prototype._resolveFeatures = function (s) {
      ...
      var l = Object.assign(
        ...
        this._inferLegacyProtoFeatures(s),
      );
      if (this._edition) {
        if (s === "proto2") A = Object.assign({}, h);
      ...
      if (this.partOf instanceof a) {
        ...
        this._features = Object.assign(o, l || {});
      } else if (this.declaringField);
      else if (this.parent) {
        var n = Object.assign({}, this.parent._features);
        this._features = Object.assign(n, l || {});
    ...
    (c.prototype._inferLegacyProtoFeatures = function () {
      return {};
    }),
    (c.prototype.getOption = function (s) {
    ...
    (c.prototype.setOption = function (s, A, l) {
      ...
      else if (!l || this.options[s] === void 0) {
        if (this.getOption(s) !== A) this.resolved = !1;
        this.options[s] = A;
      }
      return this;
    }),
    (c.prototype.setParsedOption = function (s, A, l) {
      if (!this.parsedOptions) this.parsedOptions = [];
      var o = this.parsedOptions;
      if (l) {
        var n = o.find(function (m) {
          return Object.prototype.hasOwnProperty.call(m, s);
        });
        if (n) {
          var p = n[s];
          e.setProperty(p, l, A);
        } else ((n = {}), (n[s] = e.setProperty({}, l, A)), o.push(n));
      } else {
        var _ = {};
        ((_[s] = A), o.push(_));
      }
    ...
    (c.prototype.setOptions = function (s, A) {
      if (s)
        for (var l = Object.keys(s), o = 0; o < l.length; ++o)
          this.setOption(l[o], s[l[o]], A);
      return this;
    }),
    ...
    (c.prototype._editionToJSON = function () {
