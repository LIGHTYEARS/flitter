// Module: agent-modes-3
// Original: vc
// Type: ESM (PT wrapper)
// Exports: AbR, KsT, Q2, QsT, VsT, XsT, Y2, YsT, _9T, _LT, qe
// Category: util
...
() => {
  (Ke(),
    ...
    (XsT = ["Read", "Grep", "glob", "web_search", "read_web_page", "Bash"]),
    (YsT = [
      "Read",
      "Grep",
      "glob",
    ...
    (QsT = ["Read", "Grep", "glob", "Bash"]),
    (_9T = ["Read", "Grep", "glob", "finder"]),
    (qe = {
      finder: {
        key: "finder",
        displayName: "Finder",
        model: ya("CLAUDE_HAIKU_4_5"),
        includeTools: KsT,
        allowMcp: !1,
        allowToolbox: !1,
      },
      ...
      "code-review": {
        ...
        model: ya("GEMINI_3_1_PRO_PREVIEW"),
        includeTools: XsT,
        allowMcp: !1,
        allowToolbox: !1,
      },
