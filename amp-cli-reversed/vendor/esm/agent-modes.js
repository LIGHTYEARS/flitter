...
// Original: de
// Type: ESM (PT wrapper)
// Exports: $iT, Ab, HW, L0T, M0T, OiT, SiT, UW, aCT, diT, eCT, giT, jiT, rCT, tCT, viT
// Category: util
...
() => {
  (nm(),
    ...
    (HW = ["code_tour", "code_review", "walkthrough", "walkthrough_diagram"]),
    (viT = ["code_tour", "code_review", "walkthrough", "walkthrough_diagram"]),
    (jiT = [
      "find_thread",
      "read_thread",
      "web_search",
    ...
    (Ab = {
      SMART: {
        ...
        primaryModel: ya("CLAUDE_OPUS_4_6"),
        includeTools: UW,
        deferredTools: HW,
        visible: !0,
        visibleInV2: !0,
      ...
      FREE: {
        ...
        primaryModel: ya("CLAUDE_HAIKU_4_5"),
        includeTools: giT,
        visible: !0,
        uiHints: {
      ...
      LARGE: {
        ...
        displayName: "Large",
        description:
          "The biggest context window possible (Opus 4.6 1M tokens), for large tasks",
        primaryModel: ya("CLAUDE_OPUS_4_6"),
        includeTools: UW,
        deferredTools: HW,
        visible: !0,
    ...
    (L0T = Ab.AGG.key),
    (M0T = Object.values(Ab).map((T) => T.key)));
};
