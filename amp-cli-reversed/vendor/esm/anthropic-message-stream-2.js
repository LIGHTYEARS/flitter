    ...
    (hwT = class T {
      constructor(R, a) {
        (Fh.add(this),
          ...
          sI.set(this, void 0),
          tC.set(this, (e) => {
            if (($0(this, TC, !0, "f"), Wj(e))) e = new pi();
            if (e instanceof pi)
              return ($0(this, RC, !0, "f"), this._emit("abort", e));
      ...
      _connected(R) {
        ...
        ($0(this, aC, R, "f"),
          $0(this, eC, R?.headers.get("request-id"), "f"),
          mR(this, ZE, "f").call(this, R),
          this._emit("connect"));
      }
      get ended() {
        return mR(this, cI, "f");
      ...
      on(R, a) {
        return (
          (mR(this, yo, "f")[R] || (mR(this, yo, "f")[R] = [])).push({
            listener: a,
          }),
          this
        );
      ...
      emitted(R) {
        return new Promise((a, e) => {
          if (($0(this, Fp, !0, "f"), R !== "error")) this.once("error", e);
          this.once(R, a);
        });
      }
      async done() {
        ($0(this, Fp, !0, "f"), await mR(this, hI, "f"));
      }
      get currentMessage() {
        return mR(this, Qn, "f");
      }
      async finalMessage() {
        return (await this.done(), mR(this, Fh, "m", Xq).call(this));
      }
      async finalText() {
        return (await this.done(), mR(this, Fh, "m", GlT).call(this));
      }
      _emit(R, ...a) {
        if (mR(this, cI, "f")) return;
        if (R === "end") ($0(this, cI, !0, "f"), mR(this, JE, "f").call(this));
        let e = mR(this, yo, "f")[R];
        if (e)
          ((mR(this, yo, "f")[R] = e.filter((t) => !t.once)),
            e.forEach(({ listener: t }) => t(...a)));
        if (R === "abort") {
          let t = a[0];
          if (!mR(this, Fp, "f") && !e?.length) Promise.reject(t);
          (mR(this, rI, "f").call(this, t),
            mR(this, iI, "f").call(this, t),
            this._emit("end"));
          return;
        }
        if (R === "error") {
      ...
      _emitFinal() {
        if (this.receivedMessages.at(-1))
          this._emit("finalMessage", mR(this, Fh, "m", Xq).call(this));
      }
      async _fromReadableStream(R, a) {
        ...
        try {
          (mR(this, Fh, "m", Yq).call(this), this._connected(null));
        ...
        switch ((this._emit("streamEvent", R, a), R.type)) {
            ...
            switch (R.delta.type) {
              ...
              case "compaction_delta": {
                if (e.type === "compaction" && e.content)
                  this._emit("compaction", e.content);
                break;
              }
              default:
                FlT(R.delta);
          ...
          case "message_stop": {
            (this._addMessageParam(a),
              this._addMessage(
                qlT(a, mR(this, Cu, "f"), { logger: mR(this, sI, "f") }),
                !0,
              ));
            break;
          }
      ...
      (Zq = function () {
        ...
        return (
          $0(this, Qn, void 0, "f"),
          qlT(R, mR(this, Cu, "f"), { logger: mR(this, sI, "f") })
        );
      }),
      (KlT = function (R) {
        let a = mR(this, Qn, "f");
        ...
        switch (R.type) {
          ...
          case "message_delta":
            ...
            if (R.usage.iterations != null)
              a.usage.iterations = R.usage.iterations;
            return a;
          case "content_block_start":
            ...
            switch (R.delta.type) {
                ...
                if (e && zlT(e)) {
                  ...
                  if (
                    ...
                    try {
                      ...
                      let i = new f9(
                        `Unable to parse tool parameter JSON from model. Please retry your request or adjust your prompt. Error: ${h}. JSON: ${t}`,
                      );
                      mR(this, tC, "f").call(this, i);
                    }
                  a.content[R.index] = r;
                }
                break;
              ...
              case "compaction_delta": {
                if (e?.type === "compaction")
                  a.content[R.index] = {
                    ...e,
                    content: (e.content || "") + R.delta.content,
                  };
                break;
              }
              default:
