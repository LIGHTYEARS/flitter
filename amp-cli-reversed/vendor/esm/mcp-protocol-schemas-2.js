// Module: mcp-protocol-schemas-2
// Original: YA
// Type: ESM (PT wrapper)
// Exports: $L, $nT, $u, AG, AnT, BnT, BoT, CE, CL, CnT, CoT, DnT, DoT, EE, EL, EnT, EoT, FmR, FnT, FoT, GD, GmR, GnT, GoT, HnT, HoT, Hp, IL, InT, Iq, Iu, JnT, JoT, KD, KmR, KnT, KoT, LE, LnT, LoT, MnT, MoT, NmR, NnT, NoT, OE, OL, OnT, PG, PnT, Pq, Py, QLT, Qf, QmR, QnT, QoT, Re, RlT, RnT, SE, SL, SnT, Te, TlT, TnT, UnT, UoT, VD, VmR, VnT, VoT, Vr, W$, WnT, WoT, Wp, XLT, X_, XmR, XnT, XoT, Xr, YLT, Yf, YmR, YnT, YoT, ZmR, ZnT, ZoT, _G, _nT, a, ae, anT, bG, bnT, cnT, dE, dL, dnT, doT, enT, fG, fL, fnT, fq, fu, gL, gnT, gq, gu, hnT, hr, iG, inT, jE, jL, jP, jnT, kG, knT, kq, l9, lG, lnT, mG, mnT, mq, nG, nnT, oG, onT, pG, pnT, q$, qmR, qnT, qoT, rnT, sG, snT, tnT, uG, unT, uq, vL, vP, vnT, wnT, woT, xG, xnT, xq, xu, yG, ynT, yq, znT, zoT
// Category: schema
