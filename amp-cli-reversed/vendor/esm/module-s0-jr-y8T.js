  ...
  (s0(),
    ...
    (mK = {
        ...
        inputSchema: {
          ...
          properties: {
            ...
            read_range: {
              ...
              maxItems: 2,
              description:
                "An array of two integers specifying the start and end line numbers to view. Line numbers are 1-indexed. If not provided, defaults to [1, 1000]. Examples: [500, 700], [700, 1400]",
            },
          },
          required: ["path"],
        },
      ...
      preprocessArgs: (T, R) => {
        let a = T.path,
          e = !1;
        if (a.startsWith("~") && typeof process < "u") {
          let t = process.env.HOME || process.env.USERPROFILE;
          if (t) ((a = a.replace(/^~/, t)), (e = !0));
        }
        if (An(a)) return e ? { ...T, path: a } : void 0;
        if (R.dir) return { ...T, path: MR.resolvePath(R.dir, a).fsPath };
        return e ? { ...T, path: a } : void 0;
      },
      fn: uAT,
    }),
    (fwT = { ...mK, fn: yAT }));
