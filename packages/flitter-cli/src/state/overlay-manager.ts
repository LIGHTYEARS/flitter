// OverlayManager — centralized overlay lifecycle and rendering for flitter-cli
//
// Ported from flitter-amp/src/state/overlay-manager.ts.
// Manages a priority-ordered stack of overlay entries. Provides a declarative,
// priority-sorted system for showing/dismissing overlays.
//
// Key behaviors:
...
export class OverlayManager {
  ...
  /** Register a listener to be called when overlay state changes. */
