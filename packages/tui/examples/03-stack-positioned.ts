...
// 2. 居中对齐
const _centeredStack = new Stack({
  alignment: "center",
  children: [new SizedBox({ width: 30, height: 10 }), new Text({ data: "居中显示" })],
});

// 3. 精确定位
const _positioned = new Stack({
  children: [
