...
// 1. EdgeInsets 工厂方法
const uniform = EdgeInsets.all(2);                           // 四边各 2
const symmetric = EdgeInsets.symmetric({ horizontal: 4, vertical: 1 }); // 左右 4, 上下 1
const horiz = EdgeInsets.horizontal(3);                      // 左右各 3
const vert = EdgeInsets.vertical(1);                         // 上下各 1
const custom = EdgeInsets.only({ left: 2, top: 1 });         // 仅左 2 上 1
